...
#-------------------------------Extract all  LINEs autonomous copies and confirm LINE RVT domain through hmmscan---------------------#
  ...
  hmmscan -E 1e-05 --cpu 8  --domtblout LINEs/"$varSpecie"_Putative_LINES_RVT.ORF.domtblout --tblout LINEs/"$varSpecie"_Putative_LINES_RVT.ORF.tblout ../../../../data/RVT_MolluscaPfam.hmm LINEs/"$varSpecie"_Putative_LINES_RVT.ORF.fasta
